...
#define FOREACH_EVAL(EVAL) \
        ...
        EVAL(EVAL_IDENTITY_PRIMARY, 0xe)  \
        EVAL(EVAL_IDENTITY_REVOKE, 0xf)  \
        ...
        EVAL(EVAL_FEE_POOL, 0x14)  \
        EVAL(EVAL_NOTARY_SIGNATURE, 0x15)  \
        EVAL(EVAL_VOTING_GOVERNANCE, 0x16)  \
        EVAL(EVAL_VOTING_VOTE, 0x17)  \
        EVAL(EVAL_VOTING_POLL, 0x18)  \
        EVAL(EVAL_VOTING_SPEND, 0x19)  \
        EVAL(EVAL_QUANTUM_KEY, 0x1a)  \
